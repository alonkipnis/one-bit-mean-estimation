...
\end{itemize}
\end{thm}
The proof of Theorem~\ref{thm:normal_expansion} is given in Subsection~\ref{proof:thm:normal_expansion} below. We now use this theorem to show regularity of $\bar{\theta}_n$. We have, 
\begin{align*}
