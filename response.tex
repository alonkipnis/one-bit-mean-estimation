...
\begin{response}
Thank you for this comment. It made us realized that there was a mistake in the proof and we should have replaced the $o(1/n)$ term with $O(n^{-2})$. We now provide a more detailed derivation of the expansion of $D^\star$ as $n\to \infty$ that provides the second order term. 
\end{response}
