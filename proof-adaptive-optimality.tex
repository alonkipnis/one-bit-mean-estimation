...
\begin{proof-of-lemma}[\ref{lem:bound_intervals_delta}]
  ...
  \begin{align*}
    & g(y_1,\ldots,y_N) = \frac{\left| f(y_1)-f(x^*)  \right|^{2+\delta}} { 
  ...
  \begin{align*}
    ...
    {\left| \sum_{i=1}^{k} s_i F(y_i) + s_{i^*} F(x^*) - \sum_{i=k+1}^{N-1} s_i F(y_i) \right|^{1+\delta}\left|1- \left( \sum_{i=1}^{k} s_i F(y_i) + s_{i^*} F(x^*) - \sum_{i=k+1}^{N-1} s_i F(y_i) \right)  \right|^{1+\delta} },
  \end{align*}
  ...
  \begin{align*}
    ...
    \frac{ \left| \sum_{i=2}^{k} s_i f(y_i) + s_{i^*} f(x^*) - \sum_{i=k+1}^{N} s_i f(y_i) \right|^{2+\delta}} 
         {\left| 1+ \sum_{i=2}^{k} s_i F(y_i) + s_{i^*} F(x^*) - \sum_{i=k+1}^{N} s_i F(y_i) \right|^{1+\delta}\left|-\left( \sum_{i=2}^{k} s_i F(y_i) + s_{i^*} F(x^*) - \sum_{i=k+1}^{N} s_i F(y_i) \right)  \right|^{1+\delta} },
         \\
         & = \frac{ \left| -\sum_{i=2}^{k} s_i f(y_i) - s_{i^*} f(x^*) + \sum_{i=k+1}^{N} s_i f(y_i) \right|^{2+\delta}} 
