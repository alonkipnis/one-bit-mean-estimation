...
\begin{corollary}{\cite[Thms. 3 \& 4]{PolyakJu92}}
  ...
  \item \label{item:zero-gradient}
    ...
    \end{equation}
    \newtext{for all $|x|<r$ for some $r>0$ small enough. }
  \item The function 
...
is Lipschitz continuous, \newtext{$\sqrt{f}$ is Lipschitz continuous hence absolutely continuous}. We see that the location family
...
\end{align*}
\newtext{
From here, existence of the second moment of $\pi$ implies \eqref{eq:thm:sgd_3}. }
