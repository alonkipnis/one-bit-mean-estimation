...
\begin{itemize}
\item [(i)\,\,] The pdf $f(x)$ of $X_n-\theta$ is log-concave, differentiable, and symmetric. Furthermore, there exists $\delta>0$ such that the function $\eta^{1+\delta}(x)/f^\delta(x)$ is non-increasing in $|x|$ and is uniquely maximized by the $x=0$. 
